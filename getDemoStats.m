...
demosaicing images in <cameraDir>.txt
...
thresh = 0.035; % used for edge detection
d = datestr(now);
diary(['getDemoStats ',d,'.diary']);
...
Log file contains the filename, cam #, and photo # of last photo
processed. Computation will start at next photo if software crashes or is
killed. To run software for first time, you must edit this file so it
reads: filename 1 0. Image stats are saved in text files, one file per
camera, in the statistics directory. Each line in these files contains
statistics for an individual image.
%}
photoDirectory = '/students/home/semistatic/summer2011/crops/';
logDirectory = '/students/home/visionmatlab/workspace/iStatDemo.log';
statsDirectory = '/students/home/visionmatlab/stats/07-30-demo/';
